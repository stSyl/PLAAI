...
# ABRIX - Assessment Rubrics

Transparent performance expectations and criteria for assessment

<details>
  <summary>About ...</summary>
  <p>
  <table style="width:100%; font-size:75%;">
  <tr><td>Short Title: </td><td>Rubrics</td></tr>
  ...
  <tr><td>Tree style: </td><td>show:TRUE; col:#F0F6E0; size:10; order:240</td></tr>
  </table>
  </p>
</details>

## Task:
The Assessment Rubrics pattern supports a clear communication of criteria and performance expectations to students, which aids in guiding their work and self-assessment. It boosts consistency and transparency in evaluations, offering targeted feedback for improvement. Moreover, it fosters transparent and equitable grading, reducing biases, and enriching communication between instructors and students.
