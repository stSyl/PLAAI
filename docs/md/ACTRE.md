...
# ACTRE - Active Reading

Improving comprehension and retention through active engagement

<details>
  <summary>About ...</summary>
  <p>
  <table style="width:100%; font-size:75%;">
  <tr><td>Short Title: </td><td>Active</td></tr>
  ...
  <tr><td>Tree style: </td><td>show:FALSE; col:#E1EEE5; size:10; order:210</td></tr>
  </table>
  </p>
</details>

## Task:
The Active Reading pattern propels learners to interact with the text during reading, thereby improving comprehension and retention. By proposing techniques like annotating, highlighting, summarizing, and questioning, this pattern fosters critical thinking and active participation. However, to make it work, it's crucial that learners understand the purpose and correctly apply the techniques. Providing clear instructions, examples, and regular feedback can help overcome this challenge.
