...
# ADPTT - Adaptive Testing

Adjusting the difficulty level of assessment tasks  based on student performance

<details>
  <summary>About ...</summary>
  <p>
  <table style="width:100%; font-size:75%;">
  <tr><td>Short Title: </td><td>Adaptive</td></tr>
  ...
  <tr><td>Tree style: </td><td>show:FALSE; col:#E1EEE5; size:10; order:190</td></tr>
  </table>
  </p>
</details>

## Task:
The Adaptive Testing pattern supports a form of assessment that modulates question difficulty based on learner performance. It provides an accurate measure of a student's abilities while alleviating test anxiety and frustration, targeting limitations of static assessments. To ensure a more personalized and efficient testing experience, it's crucial to balance challenge and achievability, maintain transparency about the adaptive process, and provide supportive feedback alongside.
...
<tr><td><li><a href="https://stsyl.github.io/PLAAI/md/AMODE.md">AMODE</a> (Assessment Mode)</li>
</td></tr>
