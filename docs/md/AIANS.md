...
Obtaining answers that draw on the vast knowledge base of the Language Model

<details>
  <summary>About ...</summary>
  <p>
  <table style="width:100%; font-size:75%;">
  <tr><td>Short Title: </td><td>AI answers</td></tr>
  ...
  <tr><td>Tree style: </td><td>show:TRUE; col:#d1f7f2; size:10; order:76</td></tr>
  </table>
  </p>
</details>

## Task:
The Factual Knowledge pattern utilizes the extensive factual knowledge of AI language models to provide answers across a wide variety of subjects. This is especially valuable in discourse, since answers can be obtained immediately, specific to a given context, and can be further clarified and augmented in follow-up questions. Challenges arise from the training data cutoff date, the AI's propensity to state "Schrödinger Facts" - i.e. factually wrong statements, presented with great conviction - when no actual information exists, and by the AI's biased treatment of some subjects, which has been introduced by alignment training. Effective use requires asking precise questions, engaging critically with the answers, and understanding the limitations.
...
<tr><td><li><a href="https://stsyl.github.io/PLAAI/md/AISYN.md">AISYN</a> (AI Synthesized Material)</li>
</td></tr>
