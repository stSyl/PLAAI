...
# AIARG - AI Argument Extraction

Identifying and listing arguments from a text and identifying their causal connections

<details>
  <summary>About ...</summary>
  <p>
  <table style="width:100%; font-size:75%;">
  <tr><td>Short Title: </td><td>AI arguments</td></tr>
  ...
  <tr><td>Tree style: </td><td>show:TRUE; col:#d1f7f2; size:10; order:87</td></tr>
  </table>
  </p>
</details>

## Task:
The AI Argument Extraction pattern builds upon the AI's text interpretation capabilities to identify, list, and map out the causal connections between arguments within a text. This is especially useful when dealing with dense, argumentative texts, where the AI can help disentangle and clarify complex lines of reasoning. A challenge lies in the AI's tendency to miss subtle cues in the text or to misconstrue the strength or relevance of an argument. To make this pattern work well, one must validate the AI's output especially regarding its logical coherence, iteratively refine the analysis, and, where necessary, provide the AI with additional context or guidance.
...
<tr><td><li><a href="https://stsyl.github.io/PLAAI/md/AIINT.md">AIINT</a> (AI Text Interpretation)</li>
</td></tr>
