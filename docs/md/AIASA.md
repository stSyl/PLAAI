...
# AIASA - AI Assisted Assessment

Use of generated feedback for assessment purposes

<details>
  <summary>About ...</summary>
  <p>
  <table style="width:100%; font-size:75%;">
  <tr><td>Short Title: </td><td>AI assessment</td></tr>
  ...
  <tr><td>Tree style: </td><td>show:FALSE; col:#E1EEE5; size:10; order:189</td></tr>
  </table>
  </p>
</details>

## Task:
The AI-Assisted Assessment pattern leverages AI technologies to aid the evaluation of learner work, aiming to streamline the assessment process, offer personalized feedback, and reduce educator workload. This pattern addresses time-consuming manual grading and inconsistent feedback, enhancing assessment precision and efficiency. To maximize effectiveness, the technology should be thoughtfully integrated, maintaining the pedagogical approach at the forefront, and used to complement, not replace, human judgment.
...
<tr><td><li><a href="https://stsyl.github.io/PLAAI/md/GENFB.md">GENFB</a> (Generated Feedback)</li>
</td></tr>
