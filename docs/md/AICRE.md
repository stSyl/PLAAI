...
# AICRE - AI Creative Tasks

AI contributing creative ideas

<details>
  <summary>About ...</summary>
  <p>
  <table style="width:100%; font-size:75%;">
  <tr><td>Short Title: </td><td>AI Creations</td></tr>
  ...
  <tr><td>Tree style: </td><td>show:TRUE; col:#d1f7f2; size:10; order:96</td></tr>
  </table>
  </p>
</details>

## Task:
In the AI Creative Tasks pattern, AI generate a variety of creative proposals to inspiring unconventional solutions. The AI's ability to rapidly produce numerous diverse ideas, and its potential for cross-pollination of concepts from various fields are benefits for such brainstorming tastks. There is no guarntee that ideas will be relevant or feasible ideas, and careful judgement and selection is required. Best results will arise from treating the AI's output as starting points for human refinement rather than finalized products and engaging in the co-creation of novel solutions.
