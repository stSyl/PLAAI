...
# AIINT - AI Text Interpretation

Interpretation of text according to principles of text-analysis

<details>
  <summary>About ...</summary>
  <p>
  <table style="width:100%; font-size:75%;">
  <tr><td>Short Title: </td><td>AI interpret</td></tr>
  ...
  <tr><td>Tree style: </td><td>show:TRUE; col:#d1f7f2; size:10; order:86</td></tr>
  </table>
  </p>
</details>

## Task:
The AI Text Interpretation pattern leverages the AI's ability to quickly analyze and interpret texts according to the principles of text-analysis. This is particularly useful for complex texts, where the AI can help surface underlying themes, contexts, and subtexts, and tie these to the text's broader significance, and this may be particularly useful for novice users who are less familiar with the methodology. However, human text can be written from unique personal experience, or need to be understood from an emodied context, and the AI is unlikely to succeed in those cases but may propose inaccurate or factually incorrect views. Critically review the AI's interpretation,  challenge it in discourse, ask for alternatives, and iteratively improve the analysis by refining the prompts and providing feedback.
...
<tr><td><li><a href="https://stsyl.github.io/PLAAI/md/AIUND.md">AIUND</a> (AI Content Understanding)</li>
</td></tr>
