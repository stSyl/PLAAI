...
Embedding text for use in Large Language Models.

<details>
  <summary>About ...</summary>
  <p>
  <table style="width:100%; font-size:75%;">
  <tr><td>Short Title: </td><td>Embedding</td></tr>
...
## Task:
The AI Embedding pattern dicusses the use of a computational method to cross-reference discussions with a factual knowledge base. A mathematicl function describes "how similar" elements of the knowledge base are to a query., or the point of the discourse. Similar elements can then be retrieved and injected into the conversaton. This requires a bit of programming.
...
<tr><td><li><a href="https://stsyl.github.io/PLAAI/md/AIBPR.md">AIBPR</a> (AI Best-Practice)</li>
</td></tr>
