...
Using Plugins with Large Language Models.

<details>
  <summary>About ...</summary>
  <p>
  <table style="width:100%; font-size:75%;">
  <tr><td>Short Title: </td><td>Plugins</td></tr>
...
## Task:
The AI Plugins pattern discusses so-called plugins - auxiliary functions that allow a Large Language Model such as ChatGPT communicate with for a variety of resources, such as a Web search portal, and the mathematical abilities of Wolfram Alpha. The implementation in practice is a challenge that needs to be solved.
