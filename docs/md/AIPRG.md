...
# AIPRG - AI-Prompt Generators

Tools that create contextually relevant prompts for generative AI models

<details>
  <summary>About ...</summary>
  <p>
  <table style="width:100%; font-size:75%;">
  <tr><td>Short Title: </td><td>Prompt generators</td></tr>
  ...
  <tr><td>Tree style: </td><td>show:TRUE; col:#F0F6E0; size:10; order:279</td></tr>
  </table>
  </p>
</details>

## Task:
AI-Prompt generators are tools that create contextually relevant prompts for generative AI models. The primary aim of this pattern is to generate effective instructions that align with the AI model's capabilities, constraints, and the desired output. Prompts need to incorporate context information, to individualize the generated output, they need to implement proven strategies for productive prompting, and consider the model's training and technical constraints.
