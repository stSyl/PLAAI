...
# AIPWR - AI Patterened Writing

Writing according to templates, patterns and examples, for example drafting practice questions according to a given format

<details>
  <summary>About ...</summary>
  <p>
  <table style="width:100%; font-size:75%;">
  <tr><td>Short Title: </td><td>AI pattern wrtg</td></tr>
  ...
  <tr><td>Tree style: </td><td>show:TRUE; col:#d1f7f2; size:10; order:83</td></tr>
  </table>
  </p>
</details>

## Task:
The AI Patterned Writing pattern leverages AI to create text following a specific template, pattern, or example. This facilitates the quick production of repetitive, structured content such as practice questions or form letters. The challenge lies in ensuring that the pattern is actually adequate for the purpose, and that the writers' voice is preserved. Effective use requires a well-defined template and careful review of the AI's outputs.
