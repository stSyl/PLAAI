...
# AISOC - AI Socratic Dialogue

Teaching a subject through questioning the learner and helping them discover the correct solution through their own insights

<details>
  <summary>About ...</summary>
  <p>
  <table style="width:100%; font-size:75%;">
  <tr><td>Short Title: </td><td>AI Socratic</td></tr>
