...
# AITKW - AI Technical Writing

Writing in specific styles, formats or for purposes like CVs, applications, professional correspondence etc.

<details>
  <summary>About ...</summary>
  <p>
  <table style="width:100%; font-size:75%;">
  <tr><td>Short Title: </td><td>AI tech wrtg</td></tr>
  ...
  <tr><td>Tree style: </td><td>show:TRUE; col:#d1f7f2; size:10; order:84</td></tr>
  </table>
  </p>
</details>

## Task:
The AI Technical Writing pattern employs AI to generate precise, structured, and formal text, such as CVs, applications, or professional correspondence. This can enhance consistency, reduce time spent on drafting, and provide a high degree of professionalism. However, there's a risk of generating content that lacks personal touch or context-specific nuances. For effective use, clear instructions must be provided to the AI, and the generated content should be reviewed for appropriate personalization and context-sensitivity.
...
<tr><td><li><a href="https://stsyl.github.io/PLAAI/md/AIPWR.md">AIPWR</a> (AI Patterened Writing)</li>
</td></tr>
