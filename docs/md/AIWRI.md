...
# AIWRI - AI Writing Tasks

Tasks that result in the creation,  improvement, or transformation of text

<details>
  <summary>About ...</summary>
  <p>
  <table style="width:100%; font-size:75%;">
  <tr><td>Short Title: </td><td>AI writing</td></tr>
  ...
  <tr><td>Tree style: </td><td>show:TRUE; col:#d1f7f2; size:10; order:79</td></tr>
  </table>
  </p>
</details>

## Task:
The AI Writing Tasks pattern engages the AI to assist in the creation, improvement, or transformation of text. Many patterns make use of this ability, since the AI is accessible, fast, knowledgeable, and unbiased. Obvious limitations arise from the nature of generated text: it is only indirectly a result of human experience, and it does not have direct access to collections of facts. Keep the limitations in mind, iterate and revise results, and take care to have the AI work with you, not for you.
