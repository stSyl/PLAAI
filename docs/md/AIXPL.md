...
# AIXPL - AI Explanations

Explanation of facts taking context of discourse and learners' needs into consideration

<details>
  <summary>About ...</summary>
  <p>
  <table style="width:100%; font-size:75%;">
  <tr><td>Short Title: </td><td>AI explan.</td></tr>
  ...
  <tr><td>Tree style: </td><td>show:TRUE; col:#d1f7f2; size:10; order:77</td></tr>
  </table>
  </p>
</details>

## Task:
The AI Generated Explanations pattern builds on the AI's ability to consider context and user needs to provide individualized explanations that are knowledgeable and tailored to the task at hand. The pattern is especially impactful when learners have diverse backgrounds, prior knowledge, or learning styles. Note that individualization may lead to inconsistent explanations between learners, be aware when that could be an issue. To be effective, context and user needs must be suitably captured and communicated to the AI.
...
<tr><td><li><a href="https://stsyl.github.io/PLAAI/md/AIANS.md">AIANS</a> (AI Answers)</li>
</td></tr>
