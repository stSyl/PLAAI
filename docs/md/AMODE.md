...
# AMODE - Assessment Mode

Methods and activities to evaluate learners' achievements

<details>
  <summary>About ...</summary>
  <p>
  <table style="width:100%; font-size:75%;">
  <tr><td>Short Title: </td><td>Mode</td></tr>
  ...
  <tr><td>Tree style: </td><td>show:TRUE; col:#E1EEE5; size:10; order:186</td></tr>
  </table>
  </p>
</details>

## Task:
The Assessment Modes pattern guides the selection of appropriate methods and activities to evaluate learners' achievements. It helps ensure assessment methods are tailored to learning objectives and student needs, leading to more accurate and relevant assessments. Both planning and selection stratgeies and interactive prompt design are relvant for this pattern.
...
<tr><td><li><a href="https://stsyl.github.io/PLAAI/md/ASMNT.md">ASMNT</a> (Assessment)</li>
</td></tr>
