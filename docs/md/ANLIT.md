...
# ANLIT - Annotated Literature

Collecting and evaluating relevant sources

<details>
  <summary>About ...</summary>
  <p>
  <table style="width:100%; font-size:75%;">
  <tr><td>Short Title: </td><td>Annotations</td></tr>
  ...
  <tr><td>Tree style: </td><td>show:FALSE; col:#E1EEE5; size:10; order:145</td></tr>
  </table>
  </p>
</details>

## Task:
The Annotated Literature pattern allows learners to deeply engage with texts by providing notes or explanations. This pattern aims to foster deeper understanding and critical thinking. Ensure its effectiveness by addressing issues such as focusing on relevant information, encouraging concise annotations, and promoting effective summarization.
