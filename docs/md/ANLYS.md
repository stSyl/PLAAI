...
Critical examination of concepts, data, or text

<details>
  <summary>About ...</summary>
  <p>
  <table style="width:100%; font-size:75%;">
  <tr><td>Short Title: </td><td>Analysis</td></tr>
  ...
  <tr><td>Tree style: </td><td>show:TRUE; col:#E1EEE5; size:10; order:146</td></tr>
  </table>
  </p>
</details>

## Task:
The Analysis Tasks pattern poses challenges for learners to examine data, texts, or concepts critically, aiming to develop problem-solving and critical thinking skills. Enhance its effectiveness by establishing clear objectives, promoting deep inquiry, and providing appropriate guidance to learners.
