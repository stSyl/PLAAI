...
# AUTHA - Authentic Assessment

Assessment tasks that replicate real-world scenarios

<details>
  <summary>About ...</summary>
  <p>
  <table style="width:100%; font-size:75%;">
  <tr><td>Short Title: </td><td>Authentic</td></tr>
  ...
  <tr><td>Tree style: </td><td>show:FALSE; col:#E1EEE5; size:10; order:191</td></tr>
  </table>
  </p>
</details>

## Task:
The Authentic Assessment pattern fosters the evaluation of learners through tasks that mimic real-world scenarios. It seeks to assess students' abilities to apply their learning in realistic contexts, addressing assessments that lack real-world relevance. To create an engaging and effective evaluation of student learning, educators should design authentic tasks that align with curriculum goals and provide clear criteria for success.
