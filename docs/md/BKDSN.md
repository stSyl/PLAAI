...
# BKDSN - Backward Design

A methodology that starts with defining educational goals, designs assessments to gauge whether they were achieved, and then for successful assessment.

<details>
  <summary>About ...</summary>
  <p>
  <table style="width:100%; font-size:75%;">
  <tr><td>Short Title: </td><td>Backward</td></tr>
  ...
  <tr><td>Tree style: </td><td>show:FALSE; col:#CEE0F2; size:10; order:16</td></tr>
  </table>
  </p>
</details>

## Task:
The Backward Design  pattern supports a design methodology that starts from defined learning goals and desired outcomes, then designs assessments and activities to achieve them. To optimize BKDSN, focus on: clarifying learning objectives, alignment of assessments and activities, and iterative evaluation and revision.
