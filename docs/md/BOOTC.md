...
Intense, short term, continuos, focused learning experiences 

<details>
  <summary>About ...</summary>
  <p>
  <table style="width:100%; font-size:75%;">
  <tr><td>Short Title: </td><td>Bootcamp</td></tr>
  ...
  <tr><td>Tree style: </td><td>show:FALSE; col:#E1EEE5; size:10; order:60</td></tr>
  </table>
  </p>
</details>

## Task:
The Bootcamp pattern offers intensive, short-term programs that teach specific skills or subjects. The pattern's goal is rapid skill development and readiness for employment or further study. Addressing instructional quality, pacing, and learner support are key to its success.
...
<tr><td><li><a href="https://stsyl.github.io/PLAAI/md/WRKSH.md">WRKSH</a> (Workshop)</li>
</td></tr>
