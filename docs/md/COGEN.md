...
<details>
  ...
  <tr><td>Short Title: </td><td>Engagement</td></tr>
  ...
  <tr><td>Tree style: </td><td>show:FALSE; col:#E1EEE5; size:10; order:213</td></tr>
  </table>
  </p>
</details>

## Task:
The Cognitive Engagement pattern ensures that learners are actively processing and linking new information with prior knowledge. Designing tasks that challenge learners, promote critical thinking, and encourage problem-solving and reflection make this pattern effective. It's crucial to strike a balance between challenge and achievability, ensuring tasks are demanding yet within the learner's reach.
