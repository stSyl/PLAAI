...
# COGRA - Contract Grading

Assessment based on pre-negotiated goals and standards

<details>
  <summary>About ...</summary>
  <p>
  <table style="width:100%; font-size:75%;">
  <tr><td>Short Title: </td><td>Contract</td></tr>
  ...
  <tr><td>Tree style: </td><td>show:TRUE; col:#E1EEE5; size:10; order:184</td></tr>
  </table>
  </p>
</details>

## Task:
The Contract Grading pattern provides an alternative assessment method focusing on individualized learning goals and growth. It champions student autonomy and personalized learning, while reducing grading biases and anxiety. To use this pattern effectively, clear negotiation and mutual agreement on a learning contract outlining specific criteria and objectives between the student and the instructor are crucial.
...
<tr><td><li><a href="https://stsyl.github.io/PLAAI/md/GOALS.md">GOALS</a> (Self-Reflection And Goal Setting)</li>
</td></tr>
