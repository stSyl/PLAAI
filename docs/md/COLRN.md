...
# COLRN - Collaborative Learning

Learning through working together as a mutually dependent collaborators
...
<details>
  ...
  <tr><td>Tree style: </td><td>show:FALSE; col:#CEE0F2; size:10; order:11</td></tr>
  </table>
  </p>
</details>

## Task:
The Collaborative Learning pattern focuses on students working together to achieve shared goals, fostering communication and problem-solving skills. To enhance COLRN, implement: diverse group composition, clear expectations and roles, and AI-facilitated collaboration tools.
