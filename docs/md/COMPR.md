...
# COMPR - Communities Of Practice

Networks of educators and professionals who share expertise and experience

<details>
  <summary>About ...</summary>
  <p>
  <table style="width:100%; font-size:75%;">
  <tr><td>Short Title: </td><td>Comm. of Practice</td></tr>
  ...
  <tr><td>Tree style: </td><td>show:TRUE; col:#F0F6E0; size:10; order:30</td></tr>
  </table>
  </p>
</details>

## Task:
The Communities of Practice pattern supports the coordination of networks of educators and professionals who share expertise and collaborate on defining and promoting best practice in a domain. It aims to improve instruction, learning experiences, and the overall effectiveness of educational activities. To make this pattern effective, make goals and benefits transparent, encourage active participation, share resources, and foster open communication.
...
<tr><td><li><a href="https://stsyl.github.io/PLAAI/md/SUPRT.md">SUPRT</a> (Support)</li>
</td></tr>
