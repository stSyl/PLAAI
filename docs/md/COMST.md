...
# COMST - Community Standards

Standards through which academic communities define membership

<details>
  <summary>About ...</summary>
  <p>
  <table style="width:100%; font-size:75%;">
  <tr><td>Short Title: </td><td>Standards</td></tr>
  ...
  <tr><td>Tree style: </td><td>show:FALSE; col:#F0F6E0; size:10; order:243</td></tr>
  </table>
  </p>
</details>

## Task:
The Community Standards pattern is a set of guidelines that detail expected behavior within a learning community, nurturing a positive and inclusive environment. The pattern encourages respectful and constructive interactions among community members. To make it effective, establish clear expectations, promote open communication, and model respectful behavior.
