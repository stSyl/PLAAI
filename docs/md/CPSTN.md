...
A course that builds on an entire program and signifies its succesful completion 

<details>
  <summary>About ...</summary>
  <p>
  <table style="width:100%; font-size:75%;">
  <tr><td>Short Title: </td><td>Capstone</td></tr>
  ...
  <tr><td>Tree style: </td><td>show:FALSE; col:#E1EEE5; size:10; order:53</td></tr>
  </table>
  </p>
</details>

## Task:
The Capstone pattern incorporates an integrative course that utilizes knowledge and skills accumulated throughout a program. This course enables learners to demonstrate mastery and readiness for post-educational objectives. The challenge lies in encapsulating the program's breadth and depth while offering an authentic competency assessment. The pattern flourishes when capstone projects have explicit objectives, embody real-world contexts, and include structured feedback and reflective elements.
