...
# CRNCR - Credit/No Credit

Reducing pressure by documenting achievement, not comparison

<details>
  <summary>About ...</summary>
  <p>
  <table style="width:100%; font-size:75%;">
  <tr><td>Short Title: </td><td>CR/NCR</td></tr>
  ...
  <tr><td>Tree style: </td><td>show:FALSE; col:#E1EEE5; size:10; order:182</td></tr>
  </table>
  </p>
</details>

## Task:
The Credit/No Credit pattern reduces the pressure of traditional grading scales by assessing students based on whether they meet course requirements. The pattern encourages risk-taking, learning for its own sake, and prioritizing understanding over performance metrics. Successful implementation requires a shift in focus from achievement metrics to the learning process itself.
