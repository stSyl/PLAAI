...
# CRSMP - Course Mapping

Considering course-related activities in an explicit sequence, and scheduling when to engage with them.

<details>
  <summary>About ...</summary>
  <p>
  <table style="width:100%; font-size:75%;">
  <tr><td>Short Title: </td><td>Mapping</td></tr>
  ...
  <tr><td>Tree style: </td><td>show:FALSE; col:#E1EEE5; size:10; order:226</td></tr>
  </table>
  </p>
</details>
