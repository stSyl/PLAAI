...
# CULTR - Culturally Responsive Teaching

Recognition and utilization of learners' diverse cultural backgrounds

<details>
  <summary>About ...</summary>
  <p>
  <table style="width:100%; font-size:75%;">
  <tr><td>Short Title: </td><td>Culturally</td></tr>
  ...
  <tr><td>Tree style: </td><td>show:FALSE; col:#CEE0F2; size:10; order:21</td></tr>
  </table>
  </p>
</details>

## Task:
The Culturally Responsive Teaching pattern promotes the recognition of and respect for the diverse cultural backgrounds of learners. Frequently this can be done by incorporating their experiences into the learning process. To apply the pattern, consider drafting inclusive content, acknowledging cultural differences, and fostering a supportive learning environment. The AI's knowledge of other cultures is a valuable asset in this.
...
<tr><td><li><a href="https://stsyl.github.io/PLAAI/md/INDSN.md">INDSN</a> (Instructional Design)</li>
</td></tr>
