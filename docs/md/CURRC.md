...
# CURRC - Curriculum Information

The scope of learning objectives and a structured plan for their achievement

<details>
  <summary>About ...</summary>
  <p>
  <table style="width:100%; font-size:75%;">
  <tr><td>Short Title: </td><td>Curriculum</td></tr>
  ...
  <tr><td>Tree style: </td><td>show:FALSE; col:#CEE0F2; size:10; order:23</td></tr>
  </table>
  </p>
</details>

## Task:
The Curriculum Information pattern engages with the structured plan that outlines the normed content, learning objectives, and assessment methods for an educational program or course. The primary goal of the pattern is to assist education design and delivery by making curriculum information available to gauge the relevance of specific course goals, and by supporting the evaluation of learning progress against curricular requirements and standards.
...
<tr><td><li><a href="https://stsyl.github.io/PLAAI/md/EDTHE.md">EDTHE</a> (Educational Theories)</li>
</td></tr>
