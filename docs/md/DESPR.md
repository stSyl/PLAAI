...
# DESPR - Design Project

The envisioning of a product or service to develop problem solving, and innovation

<details>
  <summary>About ...</summary>
  <p>
  <table style="width:100%; font-size:75%;">
  <tr><td>Short Title: </td><td>Design</td></tr>
  ...
  <tr><td>Tree style: </td><td>show:FALSE; col:#E1EEE5; size:10; order:135</td></tr>
  </table>
  </p>
</details>

## Task:
The Design Project pattern involves the creation of a product, service, or system, aiming to enhance students' design thinking, problem-solving, and innovation skills. This pattern can be optimized through collaboration, the provision of appropriate resources and support, and the encouragement of iterative feedback and refinement.
...
<tr><td><li><a href="https://stsyl.github.io/PLAAI/md/PRJCT.md">PRJCT</a> (Project)</li>
</td></tr>
