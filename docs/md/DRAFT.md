...
Preliminary versions of a written work for iterated critique and revision

<details>
  <summary>About ...</summary>
  <p>
  <table style="width:100%; font-size:75%;">
  <tr><td>Short Title: </td><td>Draft</td></tr>
  ...
  <tr><td>Tree style: </td><td>show:TRUE; col:#E1EEE5; size:10; order:140</td></tr>
  </table>
  </p>
</details>

## Task:
The Drafting Tasks pattern supports the refining of students' ideas through preliminary versions of a written work. Enhancing the quality of the final product is the central goal, achieved by iteratively improving structure, content, and clarity. Challenges can include unclear expectations and lack of guidance. Address these by providing clear expectations, offering consistent guidance, and delivering constructive feedback to optimize drafting tasks.
