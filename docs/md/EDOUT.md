...
# EDOUT - Educational Outcomes

The intended results of a learning process or program

<details>
  <summary>About ...</summary>
  <p>
  <table style="width:100%; font-size:75%;">
  <tr><td>Short Title: </td><td>Outcomes</td></tr>
  ...
  <tr><td>Tree style: </td><td>show:TRUE; col:#CEE0F2; size:10; order:41</td></tr>
  </table>
  </p>
</details>

## Task:
The Educational Outcomes pattern maps the intended results of a learning process or program. The pattern's prime aim is to clarify what learners are expected to understand, perform or acquire upon completion of a course or program. The pattern encounters challenges like unrealistic or vague expectations, and a mismatch between the course content, instructional methods, or assessment strategies. To optimally utilize this pattern, the establishment of measurable, explicit and attainable outcomes that align with course content, instructional methods, and assessment strategies is essential. Regular appraisal and adjustment of these outcomes based on learner performance and feedback also prove effective.
...
<tr><td><li><a href="https://stsyl.github.io/PLAAI/md/EDCNC.md">EDCNC</a> (Educational Concepts)</li>
</td></tr>
