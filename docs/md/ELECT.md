...
Courses that are not mandatory in a program but are taken out of interest

<details>
  <summary>About ...</summary>
  <p>
  <table style="width:100%; font-size:75%;">
  <tr><td>Short Title: </td><td>Elective</td></tr>
  ...
  <tr><td>Tree style: </td><td>show:FALSE; col:#E1EEE5; size:10; order:52</td></tr>
  </table>
  </p>
</details>

## Task:
The Elective pattern empowers learners by enabling course selection based on personal interests, not solely program obligations. This pattern heightens motivation, enhances engagement, and enables personalized learning pathways. A significant challenge is ensuring these courses supplement the core curriculum without detracting from it. The pattern thrives when elective courses are relevant, high-quality, and offer a diverse range of exploration.
