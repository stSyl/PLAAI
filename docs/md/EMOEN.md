...
# EMOEN - Emotional Engagement

Maintaining awareness of learners' feelings and emotions during learning

<details>
  <summary>About ...</summary>
  <p>
  <table style="width:100%; font-size:75%;">
  <tr><td>Short Title: </td><td>Emotional</td></tr>
  ...
  <tr><td>Tree style: </td><td>show:FALSE; col:#E1EEE5; size:10; order:123</td></tr>
  </table>
  </p>
</details>

## Task:
The Emotional Engagement pattern focuses on learners' feelings during the learning process. A safe and supportive environment, meaningful and relevant content, and empathizing with learners' unique experiences are vital to successfully implementing this pattern.
...
<tr><td><li><a href="https://stsyl.github.io/PLAAI/md/ENGMT.md">ENGMT</a> (Engagement Strategies)</li>
</td></tr>
