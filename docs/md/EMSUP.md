...
# EMSUP - Emotional Support

Supporting learners' feelings and emotions during learning
...
<details>
  ...
  <tr><td>Tree style: </td><td>show:FALSE; col:#E1EEE5; size:10; order:124</td></tr>
  </table>
  </p>
</details>

## Task:
The Emotional Support pattern helps learners overcome emotional barriers to learning. Effective implementation involves fostering a sense of belonging, empathizing with learners, addressing anxieties or concerns, and offering encouragement and motivation.
