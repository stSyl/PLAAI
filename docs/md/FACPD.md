...
# FACPD - Faculty Professional Development

Training, workshops, and resources for educators

<details>
  <summary>About ...</summary>
  <p>
  <table style="width:100%; font-size:75%;">
  <tr><td>Short Title: </td><td>PD</td></tr>
  ...
  <tr><td>Tree style: </td><td>show:FALSE; col:#F0F6E0; size:10; order:249</td></tr>
  </table>
  </p>
</details>

## Task:
The Faculty Professional Development pattern supports ongoing training and workshops aimed at enhancing educators' skills and knowledge. It fosters continuous improvement and adaptability in teaching practices, with AI offering new perspectives. Challenges include ensuring accessibility, relevance, and support, and making certain that educators engage actively with new ideas.
...
<tr><td><li><a href="https://stsyl.github.io/PLAAI/md/INSUP.md">INSUP</a> (Instructor Support Resources)</li>
</td></tr>
