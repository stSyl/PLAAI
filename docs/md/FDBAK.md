...
# FDBAK - Instructor Feedback

Feedback contributed by a knowledgeable instructor that does not contribute to grading

<details>
  <summary>About ...</summary>
  <p>
  <table style="width:100%; font-size:75%;">
  <tr><td>Short Title: </td><td>Instructor</td></tr>
  ...
  <tr><td>Tree style: </td><td>show:FALSE; col:#E1EEE5; size:10; order:169</td></tr>
  </table>
  </p>
</details>

## Task:
The Instructor Feedback pattern equips students with guidance and directions for improvement. To optimize this pattern, feedback must be timely, precise, actionable, and attuned to learning objectives. This ensures students receive valuable insights that further their growth and development.
