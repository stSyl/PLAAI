...
# GENFB - Generated Feedback

Synthesized, specific critique of learner submitted work

<details>
  <summary>About ...</summary>
  <p>
  <table style="width:100%; font-size:75%;">
  <tr><td>Short Title: </td><td>Generated</td></tr>
  ...
  <tr><td>Tree style: </td><td>show:TRUE; col:#E1EEE5; size:10; order:188</td></tr>
  </table>
  </p>
</details>

## Task:
The Generated Feedback pattern supports the automated creation of personalized feedback for learners based on their performance. It targets timely and specific responses that cater to individual learning needs, working against delayed or generic feedback. For successful implementation, educators should calibrate the AI to align with educational objectives and learning outcomes, and regularly review AI-generated feedback to ensure relevancy and accuracy.
