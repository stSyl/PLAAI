...
# GOALS - Self-Reflection And Goal Setting

Negotiation and definition of goals of learning and standards of achievement

<details>
  <summary>About ...</summary>
  <p>
  <table style="width:100%; font-size:75%;">
  <tr><td>Short Title: </td><td>Self-reflection</td></tr>
  ...
  <tr><td>Tree style: </td><td>show:TRUE; col:#E1EEE5; size:10; order:183</td></tr>
  </table>
  </p>
</details>

## Task:
The Self-Reflection and Goal Setting pattern cultivates students' self-awareness and encourages ownership of their learning journey. It supports setting clear objectives, tracking progress, and adjusting strategies to boost performance. For this pattern to flourish, fostering a habit of self-reflection in learners is crucial, as it allows them to identify strengths and weaknesses, adapt to new challenges, and stay motivated.
...
<tr><td><li><a href="https://stsyl.github.io/PLAAI/md/UNGRD.md">UNGRD</a> (Ungrading)</li>
</td></tr>
