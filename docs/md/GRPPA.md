...
# GRPPA - Group Project Assessment
...
<details>
  ...
  <tr><td>Short Title: </td><td>Group project</td></tr>
  ...
  <tr><td>Tree style: </td><td>show:FALSE; col:#E1EEE5; size:10; order:193</td></tr>
  </table>
  </p>
</details>

## Task:
The Group Project Assessment pattern facilitates the evaluation of collaborative work among students, focusing on their ability to work effectively in teams, communicate, and problem-solve. It addresses the challenges of evaluating group dynamics and individual contributions. To ensure a fair and effective assessment strategy, educators should clarify expectations, roles, and assessment criteria upfront, and provide opportunities for individual and group reflection.
...
<tr><td><li><a href="https://stsyl.github.io/PLAAI/md/AUTHA.md">AUTHA</a> (Authentic Assessment)</li>
</td></tr>
