...
<details>
  ...
  <tr><td>Short Title: </td><td>Guidance</td></tr>
  ...
  <tr><td>Tree style: </td><td>show:FALSE; col:#F0F6E0; size:10; order:254</td></tr>
  </table>
  </p>
</details>

## Task:
The Guidance or Academic Advising pattern assists students in making informed decisions about their academic and career paths. AI can be used to offer personalized advice, resources, and information, empowering students to make well-informed choices.
