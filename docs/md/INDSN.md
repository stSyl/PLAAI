...
# INDSN - Instructional Design

Principles for the creation of effective education
...
<details>
  ...
  <tr><td>Tree style: </td><td>show:TRUE; col:#CEE0F2; size:10; order:13</td></tr>
  </table>
  </p>
</details>

## Task:
The Instructional Design pattern supports strategies and processes for effective education. Modern design adopts learner-centered approaches, aligns objectives, assessments, and activities, and includes iterative evaluation and revision of its products.
