...
# INLFB - In-Line Feedback

Specific and targeted feedback within a piece of work or activity

<details>
  <summary>About ...</summary>
  <p>
  <table style="width:100%; font-size:75%;">
  <tr><td>Short Title: </td><td>In-line</td></tr>
  ...
  <tr><td>Tree style: </td><td>show:TRUE; col:#E1EEE5; size:10; order:187</td></tr>
  </table>
  </p>
</details>

## Task:
The In-Line Feedback pattern assists in the provision of specific and targeted feedback within a piece of work or activity, promoting precise guidance to learners and facilitating their growth. The pattern addresses the issue of generalized or vague feedback and emphasizes detailed and meaningful comments. To optimize this, educators should ensure that comments are contextually relevant, constructive, and linked to learning outcomes.
