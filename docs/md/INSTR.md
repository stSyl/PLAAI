...
<details>
  ...
  <tr><td>Short Title: </td><td>Instruction</td></tr>
  ...
  <tr><td>Tree style: </td><td>show:TRUE; col:#E1EEE5; size:10; order:99</td></tr>
  </table>
  </p>
</details>

## Task:
Instructional activities are designed to promote active learning and engagement among students. The purpose of these activities is to create opportunities for students to apply knowledge, develop skills, and foster collaboration. To enhance instructional activities, create a variety of activities that cater to different learning styles and promote critical thinking, problem-solving, and creativity.
