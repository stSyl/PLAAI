...
# IQLRN - Inquiry-Based Learning

Learning through guided and independent investigation into complex problems.

<details>
  <summary>About ...</summary>
  <p>
  <table style="width:100%; font-size:75%;">
  <tr><td>Short Title: </td><td>Inquiry</td></tr>
  ...
  <tr><td>Tree style: </td><td>show:FALSE; col:#CEE0F2; size:10; order:8</td></tr>
  </table>
  </p>
</details>

## Task:
Inquiry-Based Learning promotes curiosity, critical thinking, and problem-solving skills by encouraging students to ask questions, explore, and discover knowledge independently. This pattern fosters a sense of ownership, autonomy, and motivation in learners, while cultivating lifelong learning habits. The pattern supports authentic, real-world learning experiences and student-centered instruction.
...
<tr><td><li><a href="https://stsyl.github.io/PLAAI/md/PEDAG.md">PEDAG</a> (Pedagogy)</li>
</td></tr>
...
## Details:
https://www.queensu.ca/ctl/resources/instructional-strategies/inquiry-based-learning
