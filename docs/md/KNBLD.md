...
# KNBLD - Knowledge Building

Creation, validation and improvement of collective conceptual artifacts as pioneered by Scardamalia and Bereiter

<details>
  <summary>About ...</summary>
  <p>
  <table style="width:100%; font-size:75%;">
  <tr><td>Short Title: </td><td>KB</td></tr>
  ...
  <tr><td>Tree style: </td><td>show:TRUE; col:#CEE0F2; size:10; order:12</td></tr>
  </table>
  </p>
</details>

## Task:
The Knowledge Building pattern engages with the pedagogy pionered by Marlene Scardamalia and Carl Bereiter. It involves learners actively constructing knowledge through inquiry, discussion, and reflection. The pattern targets: authentic learning experiences, resources for inquiry, and opportunities for peer collaboration and feedback.
