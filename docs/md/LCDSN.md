...
# LCDSN - Learner-Centred Design

Prioritizing learners' needs, preferences, and goals in the design of instructional experiences.

<details>
  <summary>About ...</summary>
  <p>
  <table style="width:100%; font-size:75%;">
  <tr><td>Short Title: </td><td>Learner centred</td></tr>
  ...
  <tr><td>Tree style: </td><td>show:TRUE; col:#CEE0F2; size:10; order:19</td></tr>
  </table>
  </p>
</details>

## Task:
The Learner-Centered Design  pattern supports to prioritize learners' needs, preferences, and goals when designing instructional experiences. LCDSN involves strategie like considering learner personas, diverse learning styles, and opportunities for learner input and customization.
