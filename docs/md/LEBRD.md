...
Promoting social recognition and motivationthrough visualizing achievements and progress

<details>
  <summary>About ...</summary>
  <p>
  <table style="width:100%; font-size:75%;">
  <tr><td>Short Title: </td><td>Leaderboards</td></tr>
  ...
  <tr><td>Tree style: </td><td>show:FALSE; col:#E1EEE5; size:10; order:128</td></tr>
  </table>
  </p>
</details>

## Task:
The Leaderboard pattern supports the social recognition of learners by visualizing their achievements and progress. It can motivate learners and promote a sense of competition and collaboration. While the potential for anxiety and disengagement needs to be managed carefully, leaderboards designed with the right intention and execution can foster an environment of collective growth.
...
<tr><td><li><a href="https://stsyl.github.io/PLAAI/md/GAMIF.md">GAMIF</a> (Gamification)</li>
</td></tr>
