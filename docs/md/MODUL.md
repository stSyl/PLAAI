...
A thematic or organizational unit within a course

<details>
  <summary>About ...</summary>
  <p>
  <table style="width:100%; font-size:75%;">
  <tr><td>Short Title: </td><td>Module</td></tr>
  ...
  <tr><td>Tree style: </td><td>show:TRUE; col:#E1EEE5; size:10; order:58</td></tr>
  </table>
  </p>
</details>

## Task:
The Modules pattern arranges content into smaller course units, providing structure and organization. This pattern improves learning outcomes by making the course more manageable. To optimize this pattern, clear objectives must be set, suitable activities offered, and resources aligned with learning goals must be provided.
