...
Self-paced learning that proceeds through assessed milestones of competence

<details>
  <summary>About ...</summary>
  <p>
  <table style="width:100%; font-size:75%;">
  <tr><td>Short Title: </td><td>Mastery</td></tr>
  ...
  <tr><td>Tree style: </td><td>show:TRUE; col:#E1EEE5; size:10; order:120</td></tr>
  </table>
  </p>
</details>

## Task:
The Mastery Learning pattern champions an instructional approach where learners progress at their own pace. Its purpose is to promote deep learning and personalization, preventing students from falling behind or being left with gaps in their understanding. To enhance its effectiveness, clear learning objectives, continuous formative feedback, opportunities for self-assessment, and personalized support should be provided.
...
<tr><td><li><a href="https://stsyl.github.io/PLAAI/md/INCEN.md">INCEN</a> (Incentives)</li>
</td></tr>
