...
<details>
  ...
  <tr><td>Short Title: </td><td>Multilingual</td></tr>
  ...
  <tr><td>Tree style: </td><td>show:FALSE; col:#CEE0F2; size:10; order:22</td></tr>
  </table>
  </p>
</details>

## Task:
The Multilingual Education pattern supports learning in multiple languages. This fosters language development and cognitive growth. The pattern includes guidance on: implementing bilingual instructional materials, developing culturally relevant content, and deploying AI-assisted language learning tools.
