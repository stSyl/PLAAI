...
# NAREV - Narrative Evaluations

Qualitative assessments of a student's performance

<details>
  <summary>About ...</summary>
  <p>
  <table style="width:100%; font-size:75%;">
  <tr><td>Short Title: </td><td>Narrative</td></tr>
  ...
  <tr><td>Tree style: </td><td>show:FALSE; col:#E1EEE5; size:10; order:181</td></tr>
  </table>
  </p>
</details>

## Task:
The Narrative Evaluation pattern champions qualitative, written assessments of a student's performance. It provides a more comprehensive and personalized evaluation than numerical scores or letter grades can offer. To successfully employ this pattern, educators need to provide nuanced, constructive, and targeted feedback that captures the full spectrum of student learning.
