...
# PCONT - PLAAI Contributors

Information about the PLAAI contributors to for attribution and credit

<details>
  <summary>About ...</summary>
  <p>
  <table style="width:100%; font-size:75%;">
  <tr><td>Short Title: </td><td>Contributors</td></tr>
  ...
  <tr><td>Tree style: </td><td>show:FALSE; col:#EEEEFE; size:10; order:4</td></tr>
  </table>
  </p>
</details>

## Task:
This pattern contains information about contributors: name, email, ORCID, and possible other information in the future.
