...
# PERBK - Peer Review And Feedback

Feedback developed by peer-learners that does not contribute to grading

<details>
  <summary>About ...</summary>
  <p>
  <table style="width:100%; font-size:75%;">
  <tr><td>Short Title: </td><td>Peer</td></tr>
  ...
  <tr><td>Tree style: </td><td>show:FALSE; col:#E1EEE5; size:10; order:171</td></tr>
  </table>
  </p>
</details>

## Task:
The Peer Review and Feedback pattern provides students with the opportunity to evaluate and provide constructive criticism on their peers' work. This pattern stimulates critical thinking, communication, and collaboration skills while enriching the understanding and awareness of diverse perspectives. It fosters a supportive learning environment and aids students in internalizing the criteria for high-quality work.
