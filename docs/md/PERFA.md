...
# PERFA - Performance-Based Assessments

Assessment through task performance

<details>
  <summary>About ...</summary>
  <p>
  <table style="width:100%; font-size:75%;">
  <tr><td>Short Title: </td><td>Performance</td></tr>
  ...
  <tr><td>Tree style: </td><td>show:FALSE; col:#E1EEE5; size:10; order:192</td></tr>
  </table>
  </p>
</details>

## Task:
The Performance-Based Assessment pattern bolsters the evaluation of student competencies through specific tasks or projects, aiming to authentically appraise student mastery and problem-solving skills. To tackle the issue of superficial assessment methods, tasks should be well-designed, reflect real-world situations, and assess holistic skills, not just content recall.
