...
# PLDSN - Pattern Design

Principles for the use of structured patterns to compose educational solutions.

<details>
  <summary>About ...</summary>
  <p>
  <table style="width:100%; font-size:75%;">
  <tr><td>Short Title: </td><td>Pattern</td></tr>
  ...
  <tr><td>Tree style: </td><td>show:TRUE; col:#CEE0F2; size:10; order:14</td></tr>
  </table>
  </p>
</details>

## Task:
The Pattern Design pattern builds off PLAAI resources. It involves developing structured instructional elements that can be adapted and reused in various contexts. Working with the pattern involves: identifying recurring challenges, analyzing effective solutions, and creating flexible pattern templates.
