...
# PMETA - PLAAI Metadata

Data about the pattern language.

<details>
  <summary>About ...</summary>
  <p>
  <table style="width:100%; font-size:75%;">
  <tr><td>Short Title: </td><td>Metadata</td></tr>
  ...
  <tr><td>Tree style: </td><td>show:FALSE; col:#EEEEFE; size:10; order:2</td></tr>
  </table>
  </p>
</details>

## Task:
A pattern to store and organize PLAAI metadata.
