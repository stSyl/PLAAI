...
# PORTF - Portfolio Assessment

Producing a curated collection of work for assessment

<details>
  <summary>About ...</summary>
  <p>
  <table style="width:100%; font-size:75%;">
  <tr><td>Short Title: </td><td>Portfolio</td></tr>
  ...
  <tr><td>Tree style: </td><td>show:FALSE; col:#E1EEE5; size:10; order:185</td></tr>
  </table>
  </p>
</details>

## Task:
The Portfolio Assessment pattern offers a way for students to showcase their learning journey and achievements through a curated collection of work samples. It encourages reflection, self-assessment, and personal growth. To effectively implement this pattern, educators should guide students in the selection of work that best represents their learning progression and aligns with learning objectives.
