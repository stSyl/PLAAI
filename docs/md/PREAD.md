...
# PREAD - Lecture Pre-Reading

Reading relevant material as preparation for upcoming lectures

<details>
  <summary>About ...</summary>
  <p>
  <table style="width:100%; font-size:75%;">
  <tr><td>Short Title: </td><td>Pre-reading</td></tr>
  ...
  <tr><td>Tree style: </td><td>show:TRUE; col:#E1EEE5; size:10; order:137</td></tr>
  </table>
  </p>
</details>

## Task:
The Lecture Pre-reading pattern prepares learners for upcoming lectures by asking them to read related materials beforehand. It enhances comprehension during lectures and stimulates discussion. Selecting relevant readings, managing the workload, and connecting pre-readings to lecture content are key elements to make this pattern effective.
...
<tr><td><li><a href="https://stsyl.github.io/PLAAI/md/RDTSK.md">RDTSK</a> (Reading Task)</li>
</td></tr>
