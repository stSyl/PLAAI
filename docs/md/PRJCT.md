...
Tasks that apply and synthesize knowledge with a defined scope and endpoint

<details>
  <summary>About ...</summary>
  <p>
  <table style="width:100%; font-size:75%;">
  <tr><td>Short Title: </td><td>Project</td></tr>
  ...
  <tr><td>Tree style: </td><td>show:TRUE; col:#E1EEE5; size:10; order:133</td></tr>
  </table>
  </p>
</details>

## Task:
The Project pattern supports practical assignments that encourage students to apply and synthesize knowledge in real-world scenarios. It stimulates students to engage in problem-solving, collaboration, and critical thinking. Clarity of objectives, guidance, and opportunities for feedback and reflection are essential for maximizing the effectiveness of this pattern.
