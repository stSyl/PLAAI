...
# RAPPT - Building Rapport

Strengthening the connection between learners and educators, trust and respect

<details>
  <summary>About ...</summary>
  <p>
  <table style="width:100%; font-size:75%;">
  <tr><td>Short Title: </td><td>Rapport</td></tr>
  ...
  <tr><td>Tree style: </td><td>show:FALSE; col:#E1EEE5; size:10; order:125</td></tr>
  </table>
  </p>
</details>

## Task:
The Rapport-Building pattern strengthens the connection between learners and educators, promoting a positive learning environment through trust and respect. To effectively build rapport, educators should be approachable, demonstrate empathy, actively listen to learners, and share personal experiences when appropriate.
...
<tr><td><li><a href="https://stsyl.github.io/PLAAI/md/EMOEN.md">EMOEN</a> (Emotional Engagement)</li>
</td></tr>
