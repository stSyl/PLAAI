...
# RECAP - Recap And Practice

Content specific summaries and questions for self-assessment of understanding

<details>
  <summary>About ...</summary>
  <p>
  <table style="width:100%; font-size:75%;">
  <tr><td>Short Title: </td><td>Practice</td></tr>
  ...
  <tr><td>Tree style: </td><td>show:TRUE; col:#E1EEE5; size:10; order:165</td></tr>
  </table>
  </p>
</details>

## Task:
The Recapitulation and Practice Question Sets pattern presents learners with opportunities to apply acquired knowledge, identify knowledge gaps, and receive valuable feedback. To optimize this pattern, the creation of diverse question types is essential, along with the alignment of these questions with learning objectives. It is also critical to provide immediate feedback supplemented with explanations and remedial suggestions.
