...
Students taking on different roles in a simulated scenario to explore a particular topic or situation

<details>
  <summary>About ...</summary>
  <p>
  <table style="width:100%; font-size:75%;">
  <tr><td>Short Title: </td><td>Role-playing</td></tr>
  ...
  <tr><td>Tree style: </td><td>show:FALSE; col:#E1EEE5; size:10; order:156</td></tr>
  </table>
  </p>
</details>

## Task:
The Role-Playing pattern supports the experiential approach where students take on different roles in a simulated scenario. This pattern fosters empathy, communication skills, and understanding of diverse perspectives. Challenges may involve scenario design, role assignment, and post-exercise debriefing. To make this pattern work well, integrate AI for scenario generation and role assignment based on learners' capabilities.
