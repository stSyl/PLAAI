...
Providing temporary support for higher competence levels

<details>
  <summary>About ...</summary>
  <p>
  <table style="width:100%; font-size:75%;">
  <tr><td>Short Title: </td><td>Scaffolding</td></tr>
  ...
  <tr><td>Tree style: </td><td>show:FALSE; col:#CEE0F2; size:10; order:15</td></tr>
  </table>
  </p>
</details>

## Task:
The Scaffolding  pattern supports the provision temporary support to learners, enabling them to reach higher competence levels. To apply this effectively, identify learners' needs, offer guidance and resources, and gradually reduce support as learners become more confident and self-reliant.
