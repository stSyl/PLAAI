...
# SCPRA - Practice Of Scholarship

Concrete skills and habits for efficient scholarship

<details>
  <summary>About ...</summary>
  <p>
  <table style="width:100%; font-size:75%;">
  <tr><td>Short Title: </td><td>Scholarship practice</td></tr>
  ...
  <tr><td>Tree style: </td><td>show:TRUE; col:#E1EEE5; size:10; order:207</td></tr>
  </table>
  </p>
</details>

## Task:
The Scholarly Practices pattern aims at nurturing students' ability to develop and apply research skills such as conducting investigations, authoring academic papers, and presenting findings. By fostering a culture of ongoing learning and growth, this pattern aids learners in fine-tuning their abilities throughout their academic journey. However, the pattern must balance the need for rigor and the risk of overwhelming learners. As such, providing clear guidelines, appropriate resources, and timely feedback will bolster its effectiveness.
...
<tr><td><li><a href="https://stsyl.github.io/PLAAI/md/XCONT.md">XCONT</a> (Cross Sectional Content)</li>
</td></tr>
