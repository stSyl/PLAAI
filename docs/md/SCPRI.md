...
# SCPRI - Principles Of Scholarship

Values and performance standards that define scholarly conduct

<details>
  <summary>About ...</summary>
  <p>
  <table style="width:100%; font-size:75%;">
  <tr><td>Short Title: </td><td>Scholarship princip.</td></tr>
  ...
  <tr><td>Tree style: </td><td>show:TRUE; col:#E1EEE5; size:10; order:196</td></tr>
  </table>
  </p>
</details>

## Task:
The Principles of Scholarship pattern reinforces academic integrity, critical thinking, and effective communication in learners' coursework and research. For effective integration, educators should model these principles in their own teaching and provide explicit guidance and feedback on student adherence.
