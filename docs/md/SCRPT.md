...
Developing written summaries of oral communication

<details>
  <summary>About ...</summary>
  <p>
  <table style="width:100%; font-size:75%;">
  <tr><td>Short Title: </td><td>Scripts</td></tr>
  ...
  <tr><td>Tree style: </td><td>show:TRUE; col:#E1EEE5; size:10; order:117</td></tr>
  </table>
  </p>
</details>

## Task:
The Written Instructional Materials pattern focuses on creating written guides, like lesson plans or lecture notes, that navigate educators or learners through a specific learning experience. Challenges include maintaining engagement, pacing, and clarity of content. To work well, the instructional materials need to align with learning objectives and effectively convey critical information.
...
<tr><td><li><a href="https://stsyl.github.io/PLAAI/md/WRCOM.md">WRCOM</a> (Written Communication)</li>
</td></tr>
