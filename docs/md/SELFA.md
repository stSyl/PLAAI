...
# SELFA - Self-Assessment

Learners' reflection on scope, form, and quality of their submitted work that is taken as a basis for grading

<details>
  <summary>About ...</summary>
  <p>
  <table style="width:100%; font-size:75%;">
  <tr><td>Short Title: </td><td>Self</td></tr>
  ...
  <tr><td>Tree style: </td><td>show:TRUE; col:#E1EEE5; size:10; order:179</td></tr>
  </table>
  </p>
</details>

## Task:
The Self-Assessment pattern allows students to reflect on their own learning and progress, thereby fostering greater ownership of their learning journey. For optimal use, clear guidelines, tools, and resources should be provided to guide self-assessment. Promoting a growth mindset and encouraging honest self-evaluation are also critical to its successful implementation.
