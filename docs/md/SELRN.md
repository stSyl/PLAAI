...
# SELRN - Social-Emotional Learning

Managing emotions, engaging in healthy relationships, and developing a constructive, resilient self

<details>
  <summary>About ...</summary>
  <p>
  <table style="width:100%; font-size:75%;">
  <tr><td>Short Title: </td><td>Emotions</td></tr>
  ...
  <tr><td>Tree style: </td><td>show:FALSE; col:#E1EEE5; size:10; order:234</td></tr>
  </table>
  </p>
</details>

## Task:
The Social-emotional Learning (SEL) pattern assists the process of acquiring and applying the knowledge, attitudes, and skills necessary to manage emotions, set and achieve positive goals, show empathy for others, establish and maintain positive relationships, and make responsible decisions. This pattern's main aim is to foster an environment that enables students to develop emotional intelligence and resilience. To optimize this pattern, implement activities that promote self-awareness, self-management, social awareness, relationship skills, and responsible decision-making.
...
<tr><td><li><a href="https://stsyl.github.io/PLAAI/md/WLMND.md">WLMND</a> (Wellness And Mindfulness)</li>
</td></tr>
