...
An interactive, collaborative learning event

<details>
  <summary>About ...</summary>
  <p>
  <table style="width:100%; font-size:75%;">
  <tr><td>Short Title: </td><td>Seminar</td></tr>
  ...
  <tr><td>Tree style: </td><td>show:TRUE; col:#E1EEE5; size:10; order:65</td></tr>
  </table>
  </p>
</details>

## Task:
Through the Seminars pattern, we promote a collaborative learning environment with a focus on student participation and in-depth discussions. SEMNR aims to encourage active learning, critical thinking, and debate. To achieve these goals, design well-structured seminars, promote student-led discussions, and provide constructive feedback. AI can support the interactive aspect by simulating discussions or providing relevant resources.
