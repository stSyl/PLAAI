...
# SPREP - Spaced Repetition

Learning through revising and reinforcing previously learned material at empirically vaildated, effective intervals

<details>
  <summary>About ...</summary>
  <p>
  <table style="width:100%; font-size:75%;">
  <tr><td>Short Title: </td><td>Repetition</td></tr>
  ...
  <tr><td>Tree style: </td><td>show:FALSE; col:#E1EEE5; size:10; order:216</td></tr>
  </table>
  </p>
</details>

## Task:
The Spaced Repetition pattern enables learners to revisit and reinforce previously learned material at increasing intervals, which significantly enhances long-term retention of knowledge. The challenge with this pattern lies in the careful scheduling and regular opportunities for recall. To effectively implement the pattern, educators should design a review schedule, provide regular opportunities for recall, and encourage learners to self-assess and adapt their study habits based on their performance.
...
<tr><td><li><a href="https://stsyl.github.io/PLAAI/md/METAC.md">METAC</a> (Metacognitive Strategies)</li>
</td></tr>
