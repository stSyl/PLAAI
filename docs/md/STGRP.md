...
Collaborative learning arrangements where students work together on specific course material

<details>
  <summary>About ...</summary>
  <p>
  <table style="width:100%; font-size:75%;">
  <tr><td>Short Title: </td><td>Study groups</td></tr>
  ...
  <tr><td>Tree style: </td><td>show:FALSE; col:#E1EEE5; size:10; order:63</td></tr>
  </table>
  </p>
</details>

## Task:
The Study Groups pattern promotes collaborative learning experiences where students explore and discuss course material. This pattern aims to enhance peer learning, critical thinking, and communication skills. To ensure the success of STGRP, focus on group dynamics, clear objectives, and foster a supportive environment. AI can act as a facilitator and content resource in these groups.
