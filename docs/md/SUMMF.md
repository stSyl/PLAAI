...
# SUMMF - Summative Feedback

Providing learners with performance feedback that is part of grading

<details>
  <summary>About ...</summary>
  <p>
  <table style="width:100%; font-size:75%;">
  <tr><td>Short Title: </td><td>Summative</td></tr>
  ...
  <tr><td>Tree style: </td><td>show:TRUE; col:#E1EEE5; size:10; order:173</td></tr>
  </table>
  </p>
</details>

## Task:
The Summative Feedback pattern provides strategies for offering students comprehensive feedback at the conclusion of a course or unit. This feedback should evaluate students' overall performance and learning progress, presenting insights and suggestions for future improvements.
