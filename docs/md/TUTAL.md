...
An instructional session, typically in small groups, that aims to strengthen understanding of previously delivered content

<details>
  <summary>About ...</summary>
  <p>
  <table style="width:100%; font-size:75%;">
  <tr><td>Short Title: </td><td>Tutorial</td></tr>
  ...
  <tr><td>Tree style: </td><td>show:TRUE; col:#E1EEE5; size:10; order:66</td></tr>
  </table>
  </p>
</details>

## Task:
The Tutorial pattern covers an instructional session, typically one-on-one or in small groups, that supports a learner's understanding of a specific topic or skill. Since common hindrances such as pacing, individual learning needs, and engagement can be addressed, misunderstandnings can be clarified, and immediate feedback can be provided, tutorials can contribute disproportionately much to learning progress. 
