...
Assessment of process and result of an achievement that is not expressed as a grade

<details>
  <summary>About ...</summary>
  <p>
  <table style="width:100%; font-size:75%;">
  <tr><td>Short Title: </td><td>Ungrading</td></tr>
  ...
  <tr><td>Tree style: </td><td>show:TRUE; col:#E1EEE5; size:10; order:180</td></tr>
  </table>
  </p>
</details>

## Task:
The Ungrading pattern supports an alternative approach to assessment, favoring learning and improvement over traditional letter grades. It fosters intrinsic motivation and self-reflection, while reducing the emphasis on competition. To effectively employ this pattern, a shift in mindset from both educators and students is needed, transitioning from a focus on grading to a more holistic, growth-oriented approach.
...
<tr><td><li><a href="https://stsyl.github.io/PLAAI/md/ATYPE.md">ATYPE</a> (Assessment Type)</li>
</td></tr>
