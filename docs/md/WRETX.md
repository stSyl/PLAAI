...
Assessments of student knowledge and understanding through written responses to specific, structured questions
...
<details>
  ...
  <tr><td>Tree style: </td><td>show:FALSE; col:#E1EEE5; size:10; order:174</td></tr>
  </table>
  </p>
</details>

## Task:
The Written Exams pattern supports the assessment of student knowledge and comprehension through written responses. To optimize this pattern's effectiveness, exams should be well-structured, clear, and synchronized with learning objectives. Furthermore, incorporating diverse question types and providing detailed feedback can augment the overall value of the assessment.
