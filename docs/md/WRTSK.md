...
Tasks that have the creation of text as their objective 

<details>
  <summary>About ...</summary>
  <p>
  <table style="width:100%; font-size:75%;">
  <tr><td>Short Title: </td><td>Writing</td></tr>
  ...
  <tr><td>Tree style: </td><td>show:TRUE; col:#E1EEE5; size:10; order:138</td></tr>
  </table>
  </p>
</details>

## Task:
The Writing Task pattern fosters students' writing skills, critical thinking, and communication abilities. This pattern encourages the practice of diverse writing styles and genres. Providing clear instructions, guidance on structure and content, and opportunities for feedback and revision can enhance the effectiveness of writing tasks.
